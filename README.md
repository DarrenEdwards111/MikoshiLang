...
**A symbolic computation language for Python** — Wolfram-style syntax, 4,794 built-in functions, pattern matching, and domain-specific packages spanning calculus, physics, chemistry, machine learning, graph theory, and more.
