...
[![Tests](https://img.shields.io/badge/tests-633%20passed-brightgreen)]()
...
[![Knowledge](https://img.shields.io/badge/knowledge_packs-6-green)]()
[![Version](https://img.shields.io/badge/version-3.4.0-orange)](https://pypi.org/project/mikoshilang/3.4.0/)
...
| **Knowledge layer (Wikidata/Wikipedia/Packs)** | ✅ 6 packs | ❌ | ✅ Curated |
| **Entity graph with SPARQL queries** | ✅ | ❌ | ✅ |
| **Domain-specific knowledge (PubChem, Crossref...)** | ✅ 6 sources | ❌ | Limited |
...
- **🌐 Knowledge layer (v3.4.0)** — 6 domain packs (PubChem, Crossref, OpenAlex, GeoNames, World Bank, AlphaFold) + Wikidata/Wikipedia. SPARQL graph queries, persistent cache, 50 canonical properties. `EntitySearch`, `EntityRelationships`, `PackSearch`. **NEW:** 200M+ protein structures from AlphaFold DB
...
# 5. Domain Packs (6 built-in sources)
...
7. ✅ Domain Packs — 6 sources: PubChem, Crossref, OpenAlex, GeoNames, World Bank, AlphaFold
...
### Domain Packs (6 Built-In Sources)

MikoshiLang v3.4.0 includes production-ready knowledge packs:
