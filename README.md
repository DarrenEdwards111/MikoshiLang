...
[![Version](https://img.shields.io/badge/version-3.7.0-orange)](https://pypi.org/project/mikoshilang/3.7.0/)
...
**MikoshiLang works perfectly with Anaconda!** If you prefer Anaconda environments:
...
# Install MikoshiLang with Jupyter support
pip install mikoshilang[jupyter]
...
**Supported on all platforms**: Windows, macOS, Linux, WSL
...
- Follow the Anaconda instructions above
- Works natively on Windows

**Option 2: WSL (Linux Subsystem)**
1. Install WSL: `wsl --install` in PowerShell
2. Open WSL terminal (Ubuntu)
3. Follow the virtual environment installation steps
4. Access Jupyter from Windows browser at `http://localhost:8888`
