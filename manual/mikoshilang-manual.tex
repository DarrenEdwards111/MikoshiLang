...
\begin{itemize}
    \item \textbf{6,327 functions} across 40+ domains: calculus, algebra, number theory, statistics, chemistry, physics, biology, ML, cryptography, engineering, hydrology, mining, manufacturing, renewable energy, and more
...
MikoshiLang provides \textbf{6,327 functions} across \textbf{40+ domains}. Below is a categorized listing.

\subsection{Version History}

\begin{itemize}
    \item \textbf{v3.1.1} (Current) — 6,327 total functions
