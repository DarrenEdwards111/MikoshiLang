...
\begin{itemize}
    \item \textbf{1,794 functions} across calculus, algebra, number theory, statistics, chemistry, physics, biology, ML, cryptography, and more
...
\subsection{New in v1.2 (452 functions)}

Version 1.2 adds major expansions in scientific computing, machine learning, and computational mathematics:

\begin{itemize}
    \item \textbf{Vector Calculus} (40) — Gradient, divergence, curl, Laplacian, directional derivatives, Hessian, Jacobian
    \item \textbf{Differential Geometry} (35) — Christoffel symbols, Riemann tensor, Ricci tensor, curvature, fundamental forms
    \item \textbf{Tensor Operations} (40) — Outer/inner products, wedge product, Hodge dual, symmetrization
    \item \textbf{Geometry} (45) — Distance, area, volume, centroid, convex hull, Voronoi diagrams
    \item \textbf{Topology} (30) — Euler characteristic, Betti numbers, homology groups, simplicial complexes
    \item \textbf{Fractals \& Chaos} (25) — Mandelbrot set, Julia sets, Lyapunov exponents, bifurcation diagrams
    \item \textbf{Coordinate Systems} (35) — Polar, cylindrical, spherical, toroidal, elliptic, bipolar
    \item \textbf{Computational Geometry} (40) — Point-in-polygon, line intersection, bounding boxes, closest pair
    \item \textbf{Machine Learning} (60) — Regression, activation functions, loss functions, optimizers, metrics
    \item \textbf{Time Series} (50) — ARIMA, autocorrelation, exponential smoothing, seasonal decomposition
    \item \textbf{Economics \& Finance} (60) — NPV, IRR, Black-Scholes, option pricing, Greeks, portfolio theory
    \item \textbf{Cryptography} (40) — SHA-256/512, MD5, modular exponentiation, discrete log, number theory
    \item \textbf{String Processing} (40) — Edit distance, alignment algorithms, tokenization, TF-IDF
    \item \textbf{Classical Mechanics} (50) — Energy, momentum, forces, orbits, oscillations, drag
    \item \textbf{Thermodynamics} (45) — Ideal gas law, entropy, heat engines, blackbody radiation
    \item \textbf{Electromagnetism} (50) — Coulomb, Ohm, Faraday, Maxwell, Lorentz force, Hall effect
    \item \textbf{Quantum Mechanics} (45) — Schrödinger equation, uncertainty, Pauli matrices, Fermi-Dirac
    \item \textbf{Relativity} (30) — Lorentz transformations, time dilation, mass-energy, Schwarzschild metric
    \item \textbf{Astronomy} (30) — Kepler's laws, stellar evolution, cosmology, Hubble law
    \item \textbf{Biology \& Genetics} (60) — DNA analysis, protein analysis, population dynamics, epidemiology
    \item \textbf{Numerical Methods} (70) — Root finding, integration, ODEs, interpolation, finite differences
    \item \textbf{Formal Logic} (60) — Propositional logic, predicate logic, proof theory, modal logic
    \item \textbf{Advanced Algebra} (60) — Gröbner bases, Galois theory, modules, quaternions
\end{itemize}
...
\section{New Domain Examples (v1.2)}
